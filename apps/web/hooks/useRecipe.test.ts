...
describe('useRecipe Hook', () => {
  ...
  const mockRecipe: RecipeWithVersion = {
    ...
    version_number: 1,
    ingredients_json: [{ name: 'pasta', quantity: 400, unit: 'g', position: 1 }],
    steps_json: [{ position: 1, text: 'Boil pasta' }],
    version_notes: null,
    version_created_at: '2024-01-01T00:00:00Z',
    version_created_by: 'user-123',
  };
  ...
  describe('Toggle favorite', () => {
    it('should toggle favorite status', async () => {
      ...
      const updatedRecipeBase = {
        ...
        is_favorite: true,
        forked_from_id: mockRecipe.forked_from_id,
        ...
        cooked_count: mockRecipe.cooked_count,
